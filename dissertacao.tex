...
\begin{siglas}
	...
	\item[FE] Fator de Escala
	\item[FN] False Negative (Falso Negativo)
	\item[FP] False Positive (Falso Positivo)
	\item[FPR] False Positive Rate (Taxa de Falso Positivo)
	\item[MTCNN] Multi-Task Cascaded Convolutional Neural Network (Rede Neural Convolucional em Cascata Multi Tarefa)
	\item[MV] Número Mínimo de Vizinhos
	\item[ReLU] Rectified Linear Units (Unidades Lineares Retificadas)
	\item[ROC] Receiver Operating Characteristic (Característica Operacional do Receptor)
	\item[TN] True Negative (Verdadeiro Negativo)
	\item[TP] True Positive (Verdadeiro Positivo)
	\item[TPR] True Positive Rate (Taxa de Verdadeiro Positivo)
\end{siglas}
