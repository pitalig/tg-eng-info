...
\begin{align} 
    ...
    VN &= N \times (1-TFP) \\
    \label{eq:profit_roc}
    TVP &= 1 + \left( \frac{N}{P \times \left( \frac{A}{H}-1 \right) } \times (TFP - 1) \right)
\end{align}

\begin{figure}[htbp]
    \centering
    \caption{Limiar de lucro exibido no espaço ROC.}
