...
\begin{figure}[htpb]
    \centering
    \caption{Representação da imagem integral.\\Imagem original (esquerda) e imagem integral (direita). A correspondência das cores demarcadas na imagem com as variáveis da Equação \ref{eq:img-integral} se da por A - amarelo, B - verde, C - azul e D - rosa.}
